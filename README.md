...
# 📖 SellIt Rails <a name="about-project"></a>

**SellIt Rails** is an app that allows users to sell or buy almost anything online.
...
```
  git clone git@github.com:jorgegoco/sell_rails.git
...
Feel free to check the [issues page](https://github.com/jorgegoco/sell_rails/issues).
